...
import { Trophy, Clock, BookOpen, Code, MessageSquare, Calculator, Lightbulb } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 max-w-4xl mx-auto w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-purple-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-purple-700">{testResults.totalTime}s</p>
        </div>
